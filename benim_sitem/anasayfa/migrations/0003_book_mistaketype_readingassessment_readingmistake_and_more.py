# Generated by Django 5.2.1 on 2025-06-14 19:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('anasayfa', '0002_alter_makale_ozet'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True, null=True, verbose_name='Eğitmen Notları')),
                ('mistake_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='anasayfa.mistaketype', verbose_name='Hata Türü')),
                ('reading_assessment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='mistakes', to='anasayfa.readingassessment', verbose_name='Okuma Değerlendirmesi')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chapters', to='anasayfa.book', verbose_name='Kitap')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='text_chapter',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='anasayfa.textchapter', verbose_name='Okunan Metin'),
        ),
    ]
